 ...
 const [theme, setTheme] = useState(localStorage.getItem("theme") ? localStorage.getItem("theme") : "light")
  ...
  return (
   ...
   <>
      ...
      <header className="relative   z-20 lg:w-11/12 mx-auto  after:absolute after:left-0 after:top-full after:z-10 after:block after:h-px after:w-full  lg:after:hidden">
        <div className="relative mx-auto max-w-full px-10 lg:max-w-5xl xl:max-w-7xl 2xl:max-w-[96rem]">
          ...
          >
            ...
            >
              ...
              <NavLink to={'/taskbord'}>
                 <li  className="flex items-stretch md:mt-6">
                <p
  ...
  {/* moon icon */}
  <svg
    className="swap-off md:h-17  text-white md:w-7 w-5 h-5 fill-current"
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24">
    <path
